...
# Fix for Ruby 3.2.10 compatibility
gem "cgi", ">= 0.4.1"
...
# Background jobs with Redis-backed durable queues
gem "sidekiq", "~> 7.3"
...
gem "redcarpet", "~> 3.6"
gem "rouge", "~> 4.2"
gem "crowd_counting_p2pnet", git: "https://github.com/marciomoretto/CrowdCounting-P2PNet.git", branch: "main"
