class Admin::SettingsController < ApplicationController
  ...
  def update
    AppSetting.update_operational_settings!(
      ...
      budget_limit_cents: settings_params[:budget_limit_cents]
    )
  ...
  def settings_params
    params.require(:settings).permit(:task_value_per_head_cents, :task_expiration_hours, :budget_limit_cents)
  end

  def load_settings
    @task_value_per_head_cents = AppSetting.task_value_per_head_cents
    @task_expiration_hours = AppSetting.task_expiration_hours
    @budget_limit_cents = AppSetting.budget_limit_cents
  end
end
